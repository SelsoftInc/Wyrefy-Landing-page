...
export const metadata = {
  title: "System Status | Wyrefy",
  description: "Current operational status of Wyrefy services and systems.",
};
    ...
    <main className="min-h-screen bg-black text-white font-sans flex flex-col pt-32">
      ...
      <div className="max-w-[1160px] mx-auto px-6 py-12 w-full flex-1">
        <article className="max-w-3xl mb-32">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-8">System Status</h1>
          <div className="space-y-6 text-white/60 leading-relaxed text-lg">
            <div className="p-6 rounded-2xl border border-white/10 bg-white/[0.02] flex items-center justify-between mb-12">
            ...
            <p>This page provides real-time updates on our system performance, maintenance schedules, and incident reports.</p>
            <p>Wyrefy infrastructure is continuously monitored for optimal uptime and reliability across all regions.</p>
          </div>
        </article>
      </div>
      <Footer />
